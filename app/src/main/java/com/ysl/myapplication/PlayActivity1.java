...
public class PlayActivity1 extends Activity implements View.OnClickListener, WindowSizeChangeNotifier.OnWindowSizeChangedListener, EZUIPlayer.EZUIPlayerCallBack{

	private static final String TAG = "PlayActivity1";
	public static final String APPKEY = "a9f5de51775d47eb8d0c489af966fe76";
	public static final String AccessToekn = "at.93oswvdf5wk8h5dpaga36a01cew559gh-9dakcpkfga-1xz4w8o-2s1uis6bzat.93oswvdf5wk8h5dpaga36a01cew559gh-9dakcpkfga-1xz4w8o-2s1uis6bz";
	public static final String PLAY_URL2 = "ezopen://open.ys7.com/C55590711/1.live";
	public static final String PLAY_URL1 = "ezopen://open.ys7.com/C50474868/1.live";
	...
	public static void startPlayActivity(Context context, String appkey, String accesstoken, String url){
		Intent intent = new Intent(context, PlayActivity1.class);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBtnPlay = (Button) findViewById(R.id.btn_play_1);

		//获取EZUIPlayer实例
		mEZUIPlayer = (EZUIPlayer) findViewById(R.id.player_ui_1);
		//设置加载需要显示的view
		...
		preparePlay();
		setSurfaceSize();
		Log.d("PlayActivity1","PLAY_URL="+playUrl);
	}
